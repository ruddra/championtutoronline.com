...
! function(e, t) {
    ...
    var s = {},
        ...
        Tt = "tinymce/ui/PanelButton",
        Rt = "tinymce/ui/ColorButton",
        At = "tinymce/ui/ComboBox",
        Bt = "tinymce/ui/Path",
        Dt = "tinymce/ui/ElementPath",
        Lt = "tinymce/ui/FormItem",
        Mt = "tinymce/ui/Form",
        Ht = "tinymce/ui/FieldSet",
        Pt = "tinymce/ui/FilePicker",
        Ot = "tinymce/ui/FitLayout",
        It = "tinymce/ui/FlexLayout",
        Ft = "tinymce/ui/FlowLayout",
        zt = "tinymce/ui/FormatControls",
        Wt = "tinymce/ui/GridLayout",
        Vt = "tinymce/ui/Iframe",
        Ut = "tinymce/ui/Label",
        qt = "tinymce/ui/Toolbar",
        $t = "tinymce/ui/MenuBar",
        jt = "tinymce/ui/MenuButton",
        Kt = "tinymce/ui/ListBox",
        Gt = "tinymce/ui/MenuItem",
        Yt = "tinymce/ui/Menu",
        Xt = "tinymce/ui/Radio",
        Jt = "tinymce/ui/ResizeHandle",
        Qt = "tinymce/ui/Spacer",
        Zt = "tinymce/ui/SplitButton",
        en = "tinymce/ui/StackLayout",
        tn = "tinymce/ui/TabPanel",
        nn = "tinymce/ui/TextBox",
        rn = "tinymce/ui/Throbber";
    r(l, [], function() {
        function e(e, t, n, r) {
        ...
        return function(e) {
            ...
            function f(e) {
                var n, r, i, a, s, l, u, f, p, m, h, g, v, b, x, w, _, N, E, k = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                    S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
                    T = /[*?+]/;
                if (e)
        ...
        return function(o, a) {
            ...
            o = o || {}, l.schema = a = a || new e, o.fix_self_closing !== !1 && (o.fix_self_closing = !0), i("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var l = this,
                    c, u = 0,
                    d, f, p = [],
                    m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, D, L, M, H, P, O, I, F = 0,
                    z = t.decode,
                ...
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), M = o.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), _ = o.validate, b = o.remove_internals, W = o.fix_self_closing, O = a.getSpecialElements(); c = H.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), i(d);
                    else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && M[d] && p.length > 0 && p[p.length - 1].name === d && i(d), !_ || (N = a.getElementRule(d))) {
                            if (E = !0, _ && (T = N.attributes, R = N.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (E = !1), m = [], m.map = {}, S.replace(P, s)) : (m = [], m.map = {}), _ && !y) {
                                if (A = N.attributesRequired, B = N.attributesDefault, D = N.attributesForced, L = N.removeEmptyAttrs, L && !m.length && (E = !1), D)
                                ...
                                if (A) {
                                    for (h = A.length; h-- && !(A[h] in m.map);); - 1 === h && (E = !1)
                                }
        ...
        return function(r, i) {
            ...
            var C = i.dom,
                x = t.each,
                w, _, N, E, k, S, T, R, A, B, D, L, M, H, P, O = i.getDoc(),
                I = document,
                F = n.ie && n.ie < 11;
            N = {
                n: [.5, 0, 0, -1],
        ...
        return function(a) {
            ...
            function v(e, t, n) {
                function r(e) {
                    ...
                    if (1 === e.nodeType && et(e) && (a = v, v = "true" === et(e), s = !0), n = ot(e.childNodes), v && !s)
                        for (i = 0, o = d.length; o > i && !L(d[i], t, e, e); i++);
                    if (p.deep && n.length) {
                ...
                function o(e, n, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
                            for (a = W.clone(o, X), c = 0; c < d.length; c++)
                                if (L(d[c], t, a, a)) {
                                    a = 0;
                                    break
                                }
            ...
            function I(t, n, r) {
                ...
                function u(e, t) {
                    var n, r;
                    if (e) r = V.getRng(!0), o(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), W.remove(e)) : (n = c(e), n.nodeValue.charAt(0) === G && (n = n.deleteData(0, 1)), W.remove(e, 1)), V.setRng(r);
        ...
        return function(r) {
            ...
            a(this, {
                ...
                mceInsertContent: function(t, n, a) {
                    ...
                    function l(e) {
                        if (w)
                            for (b = e.firstChild; b; b = b.walk(!0)) E[b.name] && b.attr("data-mce-new", "true")
                    }
                    ...
                    if (h = u.parse(a, T), l(h), b = h.lastChild, "mce_marker" == b.attr("id"))
                ...
                mceReplaceContent: function(e, t, n) {
                    r.execCommand("mceInsertContent", !1, n.replace(/\{\$selection\}/g, N.getContent({
                        format: "text"
                    })))
                },
                mceInsertLink: function(e, t, n) {
                    ...
                    "string" == typeof n && (n = {
                        href: n
                    }), r = _.getParent(N.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || S.remove("link"), n.href && S.apply("link", n, r)
                },
                selectAll: function() {
                    var e = _.getRoot(),
                        t;
                ...
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(e) {
                    var t = "align" + e.substring(7),
                        n = N.isCollapsed() ? [_.getParent(N.getNode(), _.isBlock)] : N.getSelectedBlocks(),
                        r = s(n, function(e) {
        ...
        function t(e) {
            ...
            function i(e, n, r) {
                var i, o, a;
                if (n === !1 && (n = t), n)
                    for (o = e.toLowerCase().split(" "), a = o.length; a--;) e = o[a], i = c[e], i || (i = c[e] = [], u(e, !0)), r ? i.unshift(n) : i.push(n);
                return s
            }
...
tinymce.PluginManager.add("image", function(e) {
    function t(e, t) {
        function n(e, n) {
            i.parentNode && i.parentNode.removeChild(i), t({
                width: e,
                height: n
            })
        }
    ...
    function a(i) {
        ...
        function s() {
            function t(t) {
                ...
                t.onload = function() {
                    f.width || f.height || y.setAttribs(t, {
                        width: t.clientWidth,
...
tinymce.PluginManager.add("media", function(e, t) {
    ...
    function n(t) {
        return t.getAttribute("data-mce-object") ? s(e.serializer.serialize(t, {
            selection: !0
        })) : {}
    }
...
! function(e, t) {
    ...
    var c = {},
        ...
        s = "tinymce/spellcheckerplugin/Plugin",
        d = "tinymce/PluginManager",
        u = "tinymce/util/Tools",
        f = "tinymce/ui/Menu",
        h = "tinymce/dom/DOMUtils",
        g = "tinymce/util/XHR",
        m = "tinymce/util/URI",
        p = "tinymce/util/JSON";
    r(l, [], function() {
        ...
        t.add("spellchecker", function(t, l) {
            ...
            var S, T = this,
                B, C, I, M = t.settings,
                E, P = M.spellchecker_languages || "English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,German=de,Italian=it,Polish=pl,Portuguese=pt_BR,Spanish=es,Swedish=sv";
...
! function(e, t) {
    ...
    var i = {},
        ...
        m = "tinymce/util/VK",
        f = "tinymce/tableplugin/CellSelection",
        g = "tinymce/dom/TreeWalker",
        p = "tinymce/tableplugin/Plugin",
        h = "tinymce/PluginManager";
    o(s, [c, d], function(e, n) {
        ...
        return function(l, r) {
                ...
                M = [], _ = 0, a(["thead", "tbody", "tfoot"], function(t) {
                    ...
                    a(n, function(n, l) {
                        l += e, a(H.select("> td, > th", n), function(e, n) {
                            ...
                            if (M[l])
                                for (; M[l][n];) n++;
                            for (i = o(e, "rowspan"), s = o(e, "colspan"), r = l; l + i > r; r++)
                                for (M[r] || (M[r] = []), a = n; n + s > a; a++) M[r][a] = {
                                    part: t,
                                    real: r == l && a == n,
                                    elm: e,
                                    rowspan: i,
            ...
            function h(e, t, n, o) {
                var a, l, r, i, s;
                for (a = M[t][e].elm.parentNode, r = 1; n >= r; r++)
                    if (a = H.getNext(a, "tr")) {
                        for (l = e; l >= 0; l--)
                            if (s = M[t + r][l].elm, s.parentNode == a) {
                                for (i = 1; o >= i; i++) H.insertAfter(g(s), s);
                                break
                            }
                        if (-1 == l)
                            for (i = 1; o >= i; i++) a.insertBefore(g(a.cells[0]), a.cells[0])
                    }
            }
            ...
            function v(t, n, o) {
                ...
                if (t ? (l = T(t), r = l.x, s = l.y, m = r + (n - 1), f = s + (o - 1)) : (D = I = null, a(M, function(e, t) {
                    ...
                    for (b(), i(), v = c(r, s).elm, d(v, "colSpan", m - r + 1), d(v, "rowSpan", f - s + 1), h = s; f >= h; h++)
                        for (g = r; m >= g; g++) M[h] && M[h][g] && (t = M[h][g].elm, t != v && (y = e.grep(t.childNodes), a(y, function(e) {
                            v.appendChild(e)
            ...
            function k(e) {
                ...
                if (I = T(e), D && I) {
                    ...
                    for (d = n; a >= d; d++)
                        for (c = t; o >= c; c++) e = M[d][c], e.real && (i = e.colspan - 1, s = e.rowspan - 1, i && c + i > l && (l = c + i), s && d + s > r && (r = d + s));
                    for (H.removeClass(H.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), d = n; r >= d; d++)
                        for (c = t; l >= c; c++) M[d][c] && H.addClass(M[d][c].elm, "mce-item-selected")
                }
            }
        ...
        return function(n) {
            function l() {
                function t(t) {
                    function l(e, o) {
                        var a = e ? "previousSibling" : "nextSibling",
                            l = n.dom.getParent(o, "tr"),
                            i = l[a];
                        if (i) return h(n, o, i, e), t.preventDefault(), !0;
                        var d = n.dom.getParent(l, "table"),
                            u = l.parentNode,
                    ...
                    function h(e, t, o, a) {
                        var l = g(n.dom.getParent(t, "td,th")),
                            r = p(o, l),
                            i = o.childNodes[r],
                            s = d(i, a);
                        u(s || i)
            ...
            function s() {
                ...
                function t() {
                    var t = n.selection.getRng(),
                        ...
                        a = n.dom.getParent(t.startContainer, "TD,TH");
                    if (e(n, t, o, a)) {
                        a || (a = o);
            ...
            function c() {
                n.on("keydown", function(t) {
                    if ((t.keyCode == e.DELETE || t.keyCode == e.BACKSPACE) && !t.isDefaultPrevented()) {
                        ...
                        if (o) {
                            for (var a = n.dom.select("td,th", o), l = a.length; l--;)
                                if (!n.dom.hasClass(a[l], "mce-item-selected")) return;
            ...
            return o.on("MouseDown", function(e) {
                ...
                if (s) {
                    if (i && (o.getBody().style.webkitUserSelect = ""), d = r.select("td.mce-item-selected,th.mce-item-selected"), d.length > 0) {
                        ...
                        do
                            if ("TD" == m.nodeName || "TH" == m.nodeName) {
        ...
        function i(a) {
                        ...
                        f = o.extend(f, this.toJSON()), a.undoManager.transact(function() {
                            ...
                            s(g, function(r) {
                                a.dom.setAttribs(r, {
                                    ...
                                    height: i(f.height)
                                }), o != r.parentNode.nodeName.toLowerCase() && (t = e.getParent(r, "table"), n = r.parentNode, l = e.select(o, t)[0], l || (l = e.create(o), t.firstChild ? t.insertBefore(l, t.firstChild) : t.appendChild(l)), l.appendChild(r), n.hasChildNodes() || e.remove(n)), c(r), f.align && a.formatter.apply("align" + f.align, {}, r)
                            }), a.focus()
                        })
                    }
                }))
            ...
            function R(e, t, n) {
                var o = n.getEl().getElementsByTagName("table")[0],
                    l, r, i, s, c, d = n.isRtl() || "tl-tr" == n.parent().rel;
                for (o.nextSibling.innerHTML = e + 1 + " x " + (t + 1), d && (e = 9 - e), r = 0; 10 > r; r++)
                    for (l = 0; 10 > l; l++) s = o.rows[r].childNodes[l].firstChild, c = (d ? l >= e : e >= l) && t >= r, a.dom.toggleClass(s, "mce-active", c), c && (i = s);
                return i.parentNode
            }
            var N, S = this;
            a.settings.table_grid === !1 ? a.addMenuItem("inserttable", {
                ...
                menu: [{
                    ...
                    onclick: b("mceTablePasteRowAfter"),
                    onPostRender: w
                }]
